...
const CtaBanner = ({ 
  description = "Let's discuss how Aplexor can help accelerate your company's growth and sales activities in Sweden and internationally. We want to hear from you!." 
}: CtaBannerProps) => {
  return (
