        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="font-body text-xl text-muted-foreground mb-8">
              We're passionate about helping innovative hardware companies succeed in the Nordics through expert sales representation and strategic partnerships tailored for the region.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-body text-lg text-muted-foreground leading-relaxed">
              To bridge the gap between innovative hardware startups and Nordic market success by providing expert sales representation, strategic guidance, and access to established distribution networks across the Nordics. We believe that great technology deserves great market execution in the Nordic region.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 font-body text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                Our founders, having witnessed this pattern repeatedly across various hardware sectors, decided to create a specialized agency that could bridge this critical gap specifically for the Nordics. We combine deep technical understanding with proven Nordic sales expertise to help hardware startups navigate complex B2B sales processes and build sustainable growth in the region.
              </p>
              <p>
                Today, we've helped dozens of hardware companies successfully enter the Nordics, establish key regional partnerships, and achieve significant revenue growth across the region. Our approach remains focused on building long-term relationships and delivering measurable results for every client we serve in these markets.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              },
              {
              ...
              },
                {
                  ...
                  answer: "We specialize exclusively in the Nordics. Our deep understanding of Nordic business culture, regulations, and distribution networks allows us to provide highly effective, localized support for hardware companies entering these markets."
                }
            ].map((faq, index) => (
              <Card key={index}>
        ...
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-heading text-3xl lg:text-4xl font-bold text-primary-foreground mb-4">
            ...
            <p className="font-body text-lg text-primary-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss how our team can help accelerate your hardware company's growth and market success in the Nordics.
            </p>
